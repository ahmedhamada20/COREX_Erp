                ...
                <div class="card-body">
                    <form action="{{ route('stores.update', $item->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="address" value="{{ old('address', $item->address) }}" class="form-control" required>
                        </div>


                        <div class="mb-3">
                            <label class="form-label">رقم الهاتف</label>
                            <input type="text" name="phone" value="{{ old('phone', $item->phone) }}" class="form-control" required>
                        </div>
