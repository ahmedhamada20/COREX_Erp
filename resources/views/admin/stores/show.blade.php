...
@section('title', 'تفاصيل مخزن')

@section('content')

    <div class="content-header mb-3">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="mb-0">تفاصيل مخزن</h5>

            <div class="d-flex gap-2">
                <a href="{{ route('stores.edit', $item->id) }}" class="btn btn-sm btn-success">
                    تعديل
                </a>
                <a href="{{ route('stores.index') }}" class="btn btn-sm btn-light">
                    رجوع
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-2"><strong>العنوان:</strong> {{ $item->address }}</div>
                    <div class="mb-2"><strong>رقم الهاتف:</strong> {{ $item->phone }}</div>
